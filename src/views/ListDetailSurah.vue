<template>
    ...
    <div class="mt-4 lg:mt-6">
        <router-link class="border-2 px-2 py-1 shadow-sm rounded-sm border-blue-300 text-blue-400 focus:outline-none focus:ring focus:ring-blue-300 hover:text-white hover:bg-blue-400" :to="{name: 'Surah' }">Back</router-link>
        ...
        <div class="grid grid-cols-1 border-blue-500 px-2 mt-4 lg:mt-0 lg:px-20">
